export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx7c4f90714c985841",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "e5d09808db00f064b1b62a725ac64fc4",
   ...
   */
  USERS: [“oOwia5rB9bkTlx-SAcoCtYjH3O3I”]
    {
      // 想要发送的人的名字
      name: "宝宝0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "GQuREinD9n_LGQeYa2xduJad3FVm9KHiPfJ5bUWIRak",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "杭州",
      ...
      festivals: ["type": "08-02", "name": "郭婉婷", "year": "2001", "date": "08-02"]
